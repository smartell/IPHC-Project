...
DATA_SECTION
  ...
  //---------------------------------------------------------------------------
  // Ian's additional data switches and flags
  // Mean population length at true age from external source
  init_matrix	poplenage_F(YearFirstDat,YearLastDat,AgeTrueMinDat,AgeTrueMaxDat)
  init_matrix	poplenage_M(YearFirstDat,YearLastDat,AgeTrueMinDat,AgeTrueMaxDat)

  // Multiplier for early (<=2001) age-comp SEs
  init_number	ageSEscalar

  // Use external population length at age for survey selectivity?
  init_int	survlenFLG

  // Multiplier for age-6 SEs
  init_number	age6SEscalar

  // Multiplier for age-6 SEssurvey RSS
  init_number	survRSSmult
  ...
  //
  3darray	popw(YearFirstDat,YearLastDat,1,LastAge,Sex1,Sex3)
  3darray	popl(YearFirstDat,YearLastDat,1,LastAge,Sex1,Sex3)
